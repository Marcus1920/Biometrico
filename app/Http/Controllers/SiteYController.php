...
class SiteYController extends Controller
{
    /**
    ...
    public function attendencystore()
    {
       ...
       $record = \DB::connection('mysqlSiteY')
           ->table('attendance')
    ...
    {
     $data = Input::all();
      \DB::connection('mysqlSiteY')->table('work_schedule')->insert($data);
    ...
    public function clockingliststore()
    {
      ...
      \DB::connection('mysqlSiteY')->table('clocking_temp_print')->insert($data);
     ...
     public  function  index ()
    {
        ...
        $shedule= \DB::connection('mysqlSiteY')->table('attendance')
            ->select(
                \DB::raw(
                    "

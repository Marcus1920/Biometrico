<?php
            ...
            class tyboratuiController extends Controller
            {
                /**
                ...
                public function attendencystore()
                {
                   ...
                   $record = \DB::connection('mysqltyboratui')
                       ->table('attendance')
                 ...
                 public  function  index ()
                {
                    ...
                    $shedule= \DB::connection('mysqltyboratui')->table('attendance')
                        ->select(
                            \DB::raw(
                                "

...
'mysqlsiya_db' => [
             ...
             'host' => env('DB_HOST', '127.0.0.1'),
             'port' => env('DB_PORT', '3306'),
             'database' => env('DB_DATABASE_siya_db', 'siya_db_db'),
             'username' => env('DB_USERNAME_siya_db', 'root'),
             'password' => env('DB_PASSWORD_siya_db', 'Null'),
             'unix_socket' => env('DB_SOCKET', ''),
             'charset' => 'utf8mb4',
             'collation' => 'utf8mb4_unicode_ci',
             'prefix' => '',
...
'mysqlMarcus1850' => [
             ...
             'host' => env('DB_HOST', '127.0.0.1'),
             'port' => env('DB_PORT', '3306'),
             'database' => env('DB_DATABASE_Marcus1850', 'Marcus1850_db'),
             'username' => env('DB_USERNAME_Marcus1850', 'root'),
             'password' => env('DB_PASSWORD_Marcus1850', 'Null'),
             'unix_socket' => env('DB_SOCKET', ''),
             'charset' => 'utf8mb4',
             'collation' => 'utf8mb4_unicode_ci',
             'prefix' => '',

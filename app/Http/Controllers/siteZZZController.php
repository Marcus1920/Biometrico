<?php
            ...
            class siteZZZController extends Controller
            {
                /**
                ...
                public function attendencystore()
                {
                   ...
                   $record = \DB::connection('mysqlsiteZZZ')
                       ->table('attendance')
                 ...
                 public  function  index ()
                {
                    ...
                    $shedule= \DB::connection('mysqlsiteZZZ')->table('attendance')
                        ->select(
                            \DB::raw(
                                "

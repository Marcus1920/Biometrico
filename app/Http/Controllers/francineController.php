...
class francineController extends Controller
{
    /**
    ...
    public function attendencystore()
    {
       ...
       $record = \DB::connection('mysqlfrancine')
           ->table('attendance')
     ...
     public  function  index ()
    {
        ...
        $shedule= \DB::connection('mysqlfrancine')->table('attendance')
            ->select(
                \DB::raw(
                    "

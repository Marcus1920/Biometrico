...
class SiteConnectionServices
{
    ...
    public  function  SetupDatabaseConnectionLocal ($dbName ,$SiteName  ,$SiteName_conif )
    {
...
>>>>>>> 5a3623c8f59c72c81a2ee2cab3465e5bd392a9dc
    ...
    public   function  SetConnectionEnvLocal  ($SiteName  ,$SiteName_conif )

    {
        ...
        $DB_HOST              ="DB_HOST =" ."127.0.0.1"."\n";
        $DB_DATABAS           = "DB_DATABAS$SiteName_conif =" .$SiteName."\n";
        $DB_USERNAME          = "DB_USERNAME$SiteName_conif =" ."root"."\n";
        $DB_PASSWORD          = "DB_PASSWORD$SiteName_conif=".""."\n";
